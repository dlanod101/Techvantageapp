...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'utilities.authentication.FirebaseAuthentication',
    ),
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = config('EMAIL_ID')  # Replace with your email
EMAIL_HOST_PASSWORD = config('EMAIL_PASSWORD')  # Use an app-specific password if required
DEFAULT_FROM_EMAIL = f'Techvantage {config('EMAIL_ID')}'
